...
const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    // Check if user has activated a kit
      ...
      <main className="pt-24 pb-16 flex items-center justify-center min-h-screen">
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto">
            ...
            >
              <img src={atribotLogo} alt="Atribot" className="w-16 h-16 mx-auto mb-4" />
            ...
            >
              Don't have a kit?{' '}
              <Link to="/kit_activation" className="text-primary hover:underline">
                Learn more
              </Link>
            </motion.p>
          </div>
