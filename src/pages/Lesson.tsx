      ...
      <main className="pt-20 pb-16">
        <div className="container mx-auto px-4">
          ...
          <motion.div
            ...
            className="flex items-center justify-between py-4 border-b border-border mb-6"
          >
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <motion.div
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              className="aspect-video bg-muted rounded-2xl overflow-hidden mb-8"
            >
              <div className="w-full h-full flex items-center justify-center bg-gradient-to-br from-primary/20 to-secondary/20">
                <div className="text-center">
                  ...
                  <p className="text-sm text-muted-foreground mt-2">
                    In production, this would embed the lesson video
                  </p>
                </div>
              </div>
            </motion.div>
              ...
              <Card className="bg-card border-border mb-8">
                <CardContent className="p-6">
                  ...
                  <div className="prose prose-invert max-w-none">
                    ...
                    <p className="text-muted-foreground mb-4">
                      Follow along with the video above to complete this lesson. Make sure you have 
                      all the parts from your Atribot kit ready before you begin!
                    </p>
