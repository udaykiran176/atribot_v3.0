...
import { Plus, Search, Edit, Trash2, BookOpen, GripVertical } from 'lucide-react';
...
const AdminCourses = () => {
  const [courses, setCourses] = useState<Course[]>(
    SAMPLE_COURSES.map(c => ({ ...c, published: true }))
  );
  ...
  const handleUpdate = () => {
    ...
    setCourses(courses.map(c => 
      c.id === editingCourse.id 
        ? { ...c, title: formTitle, description: formDescription, level: formLevel }
        : c
    ));
    setEditingCourse(null);
    resetForm();
          ...
          <Dialog open={isCreateOpen} onOpenChange={setIsCreateOpen}>
            ...
            <DialogContent>
              ...
              <div className="space-y-4 py-4">
                ...
                <Button variant="hero" className="w-full" onClick={handleCreate}>
                  Create Course
                </Button>
              </div>
            </DialogContent>
              ...
              <Card className="bg-card border-border">
                <CardContent className="p-4">
                  <div className="flex items-center gap-4">
                    <div className="hidden md:flex text-muted-foreground cursor-grab">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 mt-2 text-sm text-muted-foreground">
                        <Badge className={LEVELS[course.level].color}>
                          Level {LEVELS[course.level].number}
                        </Badge>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="flex items-center gap-2">
                        <Label htmlFor={`publish-${course.id}`} className="text-sm text-muted-foreground">
                          Published
                        </Label>
                        <Switch
